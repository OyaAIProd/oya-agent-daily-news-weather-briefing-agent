# Daily News & Weather Briefing Agent

> Built with [Oya AI](https://oya.ai)

## About

A punctual, well-informed morning briefing assistant who delivers crisp, structured daily digests without fail.

## Configuration

- **Mode:** skills
- **Agent ID:** `f251d7ed-22ce-4f1d-9970-571369cb442f`
...
<script
  ...
  data-agent-id="f251d7ed-22ce-4f1d-9970-571369cb442f"
  data-api-key="a2a_your_key_here"
  data-title="Daily News & Weather Briefing Agent"
></script>
```
